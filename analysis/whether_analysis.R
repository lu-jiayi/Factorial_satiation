...
participants_to_exclude = c(900, 688, 1079, 1027, 939, 827, 899, 842, 1089, 1042, 823, 905, 993, 1001, 1088, 1056, 878, 781, 1093, 836, 1011, 923, 1053, 809, 933, 981, 824, 800, 784, 1058, 913, 895, 782, 814, 838, 927, 862, 846, 943, 980, 772)
...
#simple model for island-violating sentence satiation
