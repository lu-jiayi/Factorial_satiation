...
`%notin%` <- Negate(`%in%`)
raw_data_path <- "subject_indef_adj.csv"
data<-read.csv(raw_data_path)

########Data pre-processing##########
#Remove practice items and attention checks
participants_to_exclude = c(3742,3602,3689,3733,3648,3899,3663,3744,3612, 3843,3891,3969)
...
#BF analysis for the conditional models
